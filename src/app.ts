...
//body parser
app.use(cors({
  origin:['http://localhost:3000','http://10.0.70.92:3000','http://10.0.70.92:5173','https://mithila.binarybards.online','http://31.97.171.35:3000','http://31.97.171.35:4173','http://31.97.102.139:4000',"https://movicare.cr","https://admin.movicare.cr","https://dev.movicare.cr","http://dev.movicare.cr","http://31.97.171.35:4000","http://localhost:4000"],
  credentials:true,
}));
